...
const modifyLines_1 = require("../src/tools/modifyLines");
const changeTrackingService_1 = require("../src/changeTrackingService");
suite('ModifyLinesTool Tests', () => {
    let tempDir;
    let tool;
    let changeTrackingService;
    setup(async () => {
        // Create a temporary directory for test files
        tempDir = await fs.promises.mkdtemp(path.join(os.tmpdir(), 'modify-lines-test-'));
        changeTrackingService = new changeTrackingService_1.ChangeTrackingService(tempDir);
        tool = new modifyLines_1.ModifyLinesTool(changeTrackingService);
    });
    teardown(async () => {
...
//# sourceMappingURL=modifyLines.test.js.map